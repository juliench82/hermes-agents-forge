...
| Resolve decision cards | `decision-bot` only | Decision contract schema v1; typed response recorded verbatim; **human-source gates are never auto-dispatched — resolved in the customer's live channel** | decision source (customer or Jev) |
